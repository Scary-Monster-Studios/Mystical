Shader "NatureManufacture Shaders/Water River Tesseled"
{
	...
	SubShader
	{
		...
		#include "Assets/Enviro - Sky and Weather/Resources/Shaders/Core/EnviroFogCore.cginc"
		#include "Tessellation.cginc"
		#pragma target 4.6
		#pragma surface surf StandardSpecular keepalpha vertex:vertexDataFunc tessellate:tessFunction tessphong:_TessPhongStrength finalcolor:ApplyFog
		struct Input
		{
			half2 uv_texcoord;
			float3 worldNormal;
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float lerpResult407 = lerp( ( ( _WaterTessScale * tex2Dlod( _WaterTesselation, half4( WaterSpeedValueMix516, 0, 1.0) ).r ) + ( _WaterTessScale * tex2Dlod( _WaterTesselation, half4( WaterSpeedValueMain614, 0, 1.0) ).r ) ) , ( ( ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMix433, 0, 1.0) ).r * _SmallCascadeWaterTessScale ) + ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMain600, 0, 0.0) ).r * _SmallCascadeWaterTessScale ) ) * clampResult285 ) , clampResult285);
			...
			float lerpResult568 = lerp( lerpResult407 , ( ( ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMix608, 0, 1.0) ).r ) + ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMain432, 0, 1.0) ).r ) ) * clampResult514 ) , clampResult514);
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float clampResult783 = clamp( ( pow( min( tex2DNode647.r , tex2D( _Noise, ( panner321 + float2( -0.47,0.37 ) ) ).r ) , _BigCascadeNoisePower ) * 20.0 ) , 0.0 , 1.0 );
			float lerpResult626 = lerp( ( tex2DNode213.r * 0.5 ) , tex2DNode213.r , clampResult783);
