...
namespace Atavism
{
    ...
    public class AtavismTrade : MonoBehaviour
    {
        ...
        public List<AtavismInventoryItem> MyOffers
        {
            get
            {
                foreach (AtavismInventoryItem aii in myOffers)
                {
                    if (aii != null)
                        if (aii.icon == null)
                        {
                            aii.icon = AtavismPrefabManager.Instance.GetItemIconByID(aii.templateId);
                        }
                }
                return myOffers;
            }
        ...
        public List<AtavismInventoryItem> TheirOffers
        {
            get
            {
                foreach (AtavismInventoryItem aii in theirOffers)
                {
                    if (aii != null)
                        if (aii.icon == null)
                        {
