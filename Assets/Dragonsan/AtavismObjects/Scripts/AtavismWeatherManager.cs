...
namespace Atavism
{
    ...
    public class AtavismWeatherManager : MonoBehaviour
    {
        ...
        private static AtavismWeatherManager instance;
        private Dictionary<int, WeatherProfile> profiles = new Dictionary<int, WeatherProfile>();
        ...
        void Start()
        {
            ...
            NetworkAPI.RegisterExtensionMessageHandler("ao.weather_Profiles", HandleWeatherProfiles);
            SceneManager.sceneLoaded += sceneLoaded;
            //    StartCoroutine(UpdateTimer());
        }

        private void HandleWeatherProfiles(Dictionary<string, object> props)
        {
           // Debug.LogError("HandleWeatherProfiles");
            profiles.Clear();
            ...
            AtavismEventSystem.DispatchEvent("WEATHER_PROFILE_UPDATE", args);
           // Debug.LogError("HandleWeatherProfiles END");
        }
        ...
        private void HandleWeatherSync(Dictionary<string, object> props)
        {
            ...
            if (props.ContainsKey("resynctime"))
                resynctime = (bool)props["resynctime"];
        ...
        public static AtavismWeatherManager Instance
        {
            get { return instance; }
        }

        public Dictionary<int, WeatherProfile> Profiles
        {
            get
            {
                return profiles;
        ...
        void OnDestroy()
        {
            ...
            NetworkAPI.RemoveExtensionMessageHandler("ao.weather_Profiles", HandleWeatherProfiles);
        }
    }
}