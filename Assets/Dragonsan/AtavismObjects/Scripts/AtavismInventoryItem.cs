...
#if AT_I2LOC_PRESET
            UGUITooltip.Instance.SetAdditionalType(" "+I2.Loc.LocalizationManager.GetTranslation(subType));
            UGUITooltip.Instance.AddAdditionalAttribute(I2.Loc.LocalizationManager.GetTranslation(slotName),"",true);
#else
                UGUITooltip.Instance.SetAdditionalType(" " + subType);
                UGUITooltip.Instance.AddAdditionalAttribute(slotName, "", true);
#endif
...
#if AT_I2LOC_PRESET
            UGUITooltip.Instance.SetAdditionalType2(" "+I2.Loc.LocalizationManager.GetTranslation(subType));
            UGUITooltip.Instance.AddAdditionalAttribute2(I2.Loc.LocalizationManager.GetTranslation(slotName),"",true);
#else
                UGUITooltip.Instance.SetAdditionalType2(" " + subType);
                UGUITooltip.Instance.AddAdditionalAttribute2(slotName, "", true);
#endif
