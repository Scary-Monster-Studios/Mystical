...
namespace Atavism
{
    ...
    public class AtavismAuction : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            NetworkAPI.RegisterExtensionMessageHandler("AuctionList", HandleAuctionList);
        ...
        private void OnDestroy()
        {
            ...
            NetworkAPI.RemoveExtensionMessageHandler("AuctionOwnerListUpdate", HandleAuctionOwnerListUpdate);
            NetworkAPI.RemoveExtensionMessageHandler("AuctionList", HandleAuctionList);
            NetworkAPI.RemoveExtensionMessageHandler("AuctionListUpdate", HandleAuctionListUpdate);
            NetworkAPI.RemoveExtensionMessageHandler("AuctionListForGorupUpdate", HandleAuctionListForGroupUpdate);
        }
        ...
        public void OnEvent(AtavismEventData eData)
        {
            ...
            {
                foreach (Auction a in auctions.Values)
                {
                    a.item.icon = AtavismPrefabManager.Instance.GetItemIconByID(a.item.templateId);
                }

                foreach (Auction a in ownAuctions.Values)
                {
                    a.item.icon = AtavismPrefabManager.Instance.GetItemIconByID(a.item.templateId);
                }
            }
        ...
        public void HandleAuctionOwnerListUpdate(Dictionary<string, object> props)
        {
            ...
            try
            {
              ...
              //  Debug.LogWarning("HandleAuctionOwnerListUpdate: I costStartPer="+ costStartPer+" "+ props["SPricePerc"].GetType() + " costEndPer = " + costEndPer+" "+props["cPricePerc"].GetType());
        ...
        public void HandleAuctionList(Dictionary<string, object> props)
        {
            try
            {
                auctions.Clear();
            ...
            {
                AtavismLogger.LogError("AtavismAuction.HandleAuctionList Exception " + e.Message+"\n\n"+e.StackTrace);
            }
            string[] args = new string[1];
        ...
        public void HandleAuctionListUpdate(Dictionary<string, object> props)
        {
            ...
            try
            {
             ...
             //   Debug.LogWarning("HandleAuctionListUpdate: I costStartPer=" + costStartPer + " " + props["SPricePerc"].GetType() + " costEndPer = " + costEndPer + " " + props["cPricePerc"].GetType());
            }
            catch (Exception e)
            {
        ...
        public void HandleAuctionListForGroupUpdate(Dictionary<string, object> props)
        {
            ...
            */
            try
            {
                ...
                costEndPer = (float)props["cPricePerc"];
                currecnyType = (int)props["currency"];
             //   Debug.LogWarning("HandleAuctionListForGroupUpdate: I costStartPer=" + costStartPer + " " + props["SPricePerc"].GetType() + " costEndPer = " + costEndPer + " " + props["cPricePerc"].GetType());
