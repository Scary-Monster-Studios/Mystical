...
#else
                ClientAPI.Write("Properties for: " + target.Name + " (" + target.Oid + ") with num Properties: " + target.PropertyNames.Count);
#endif
...
#else
                ClientAPI.Write("Properties for: " + target.Name + " (" + target.Oid + ") matching: " + args_str);
#endif
                foreach (string prop in target.PropertyNames)
                {
