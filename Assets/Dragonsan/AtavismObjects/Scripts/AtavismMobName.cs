    ...
    public class AtavismMobName : MonoBehaviour
    {
                ...
                if (!SceneManager.GetActiveScene().name.Equals("Login") && !SceneManager.GetActiveScene().name.Equals(ClientAPI.Instance.characterSceneName))
                    if (mobQuest != null && node != null)
                    {
                        ...
                        if(node.PropertyExists("reaction"))
                            targetType=(int)node.GetProperty("reaction");
                        ...
                        else
                        {
                            ...
                            else if (node.CheckBooleanProperty("questconcludable"))
                            {
                                ...
                                if (GetComponent<bl_MiniMapItem>() != null)
                                {
                                    ...
                                    item.SetColor( AtavismSettings.Instance.MinimapSettings.minimapQuestConcludableIconColor);
                                    item.InfoItem = "";
                                    item.DestroyWithObject = true;
                                }
                                else
                            ...
                            else if (node.CheckBooleanProperty("questinprogress"))
                            {
                                ...
                                if (GetComponent<bl_MiniMapItem>() != null)
                                {
                                    ...
                                    item.SetColor(AtavismSettings.Instance.MinimapSettings.minimapQuestProgressIconColor);
                                    item.InfoItem = "";
                                    item.DestroyWithObject = true;
                                }
                                else
                            ...
                            else if (node.CheckBooleanProperty("questavailable"))
                            {
                                ...
                                if (GetComponent<bl_MiniMapItem>() != null)
                                {
                                    ...
                                    item.SetColor(AtavismSettings.Instance.MinimapSettings.minimapQuestAvailableIconColor);
                                    item.InfoItem = "";
                                    item.DestroyWithObject = true;
                                }
                                else
                            ...
                            else if (node.CheckBooleanProperty("itemstosell"))
                            {
                                ...
                                if (GetComponent<bl_MiniMapItem>() != null)
                                {
                                    ...
                                    item.SetColor(AtavismSettings.Instance.MinimapSettings.minimapShopIconColor);
                                    item.InfoItem = "";
                                    item.DestroyWithObject = true;
                                }
                                else
            ...
            while (Camera.main != null)
            {
                if (mobName != null)
                {
                    ...
                    if (distance < renderDistance)
                    {
                        if (!death)
                        {
                            if (mobName.GetComponent<TextMeshPro>() != null)
                    ...
                    else if (mobName.GetComponent<TextMeshPro>() != null)
                        mobName.GetComponent<TextMeshPro>().enabled = false;
                }
        ...
        void UpdateNameDisplay(bool showName)
        {
            ...
            if (showName && node != null)
            {
                ...
                if (node.PropertyExists("shopTitle"))
                    shopTitle = (string)node.GetProperty("shopTitle");
                ...
                text = shopTitle+"\n"+text + mName + ownerName + "</color>" + SubTitle + title+ guildName;
            ...
            if (AtavismSettings.Instance.VisableOid && node != null)
            {
                text += "\n" + OID.fromLong(node.Oid) + " (" + node.Oid + ")";
            }
            ...
            else
            {
                if (mobName != null && mobName.GetComponent<TextMeshPro>() != null)
                {
                    if (AtavismSettings.Instance.VisibleShopMessageOnSelf)
                    {
                        mobName.GetComponent<TextMeshPro>().text = shopTitle;
                    }
                    else
        ...
        void OnDestroy()
        {
            if (node != null)
            {
                ...
                node.RemoveObjectPropertyChangeHandler("subTitle", LevelHandler);
