...
namespace Atavism
{
    ...
    public abstract  class MobController3D : AtavismMobController
    {
      ...
      //  protected GameObject mount;
        ...
        //   public bool enableReverseGravityAfterExceedingMaxDistance = true;
       ...
       protected CharacterController controller;
        ...
        public override Vector3 MoveMob()
        {
            ...
            if (pathInterpolator != null)
            {
              ...
              //  UnityEngine.Debug.Log("MobNode.ComputePosition: oid " + oid + ", followTerrain " + followTerrain + ", pathInterpolator " + (locAndDir == null ? "null" : locAndDir.ToString ())+" Pos="+ transform.position);
                if (locAndDir != null)
                {
            ...
            else
            {
                ...
                {
                  //  Debug.LogError("rotatingDirection=" + rotatingDirection + " desiredDisplacement=" + desiredDisplacement + " Rotate");
